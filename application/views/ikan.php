											...
											<div class="product-tab">
												...
												<div class="col-md-4 product-tab-grid simpleCart_shelfItem">
													<div class="grid-arr">
														<div  class="grid-arrival">
															<div class="grid-img">
																<img  src="<?php echo base_url();?>assets/images/abonlele.jpeg" class="img-responsive" alt="">
															</div>
															
														</div>
														
														<div class="fish">
															<h6><a href="abon_lele.html">Abon Ikan Lele Si Bonbon</a></h6>
															<span class="size">Original</span>
															<p><em class="item_price">Rp 31.000</em></p>
															<a href="#" data-text="Add To Cart" class="my-cart-b item_add">Tambahkan ke keranjang</a>
														</div>
													</div>
												...
												<div class="col-md-4 product-tab-grid simpleCart_shelfItem">
													<div class="grid-arr">
														<div  class="grid-arrival">
															<div class="grid-img">
																		<img  src="<?php echo base_url();?>assets/images/tekwan.jpg" class="img-responsive" alt="">
																	</div>
															
														</div>
														
														<div class="fish">
															<h6><a href="abon_lele.html">Tekwan Instan Bu Yan</a></h6>
															<span class="size">Ikan Tenggiri</span>
															<p ><em class="item_price">Rp 37.000</em></p>
															<a href="#" data-text="Add To Cart" class="my-cart-b item_add">Tambahkan ke keranjang</a>
														</div>
													</div>
											...
											<div class="product-tab prod1">
												<div class="col-md-4 product-tab-grid simpleCart_shelfItem">
													<div class="grid-arr">
														<div  class="grid-arrival">
															<div class="grid-img">
																		<img  src="<?php echo base_url();?>assets/images/bandengpresto.jpg" class="img-responsive" alt="">
																	</div>
															
														</div>
														
														<div class="fish">
															<h6><a href="abon_lele.html">Bandeng Presto Juwana</a></h6>
															<span class="size">Isi 4-5 ekor</span>
															<p ><em class="item_price">Rp 54.000</em></p>
															<a href="#" data-text="Add To Cart" class="my-cart-b item_add">Tambahkan ke keranjang</a>
														</div>
													</div>
												...
												<div class="col-md-4 product-tab-grid simpleCart_shelfItem">
													<div class="grid-arr">
														<div  class="grid-arrival">
															<div class="grid-img">
																		<img  src="<?php echo base_url();?>assets/images/keripikmujair.jpg" class="img-responsive" alt="">
																	</div>
															
														</div>
													
														<div class="fish">
															<h6><a href="abon_lele.html">Keripik Ikan Mujair</a></h6>
															<span class="size">BBQ Balado</span>
